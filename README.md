...
Blog App is web app to display user comments and post, It allows for new users to join the blog, post a comment and can also comment on post from other users.
...
```sh 
git clone https://github.com/Tafloninno/Blog_App
  ```
  ```sh 
  cd Blop-App
  ```
